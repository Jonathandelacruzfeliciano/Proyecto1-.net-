...
namespace app_de_Nomina
{
    public partial class FrmNomina : Form
    {
        ...
        public void MostrarNominas()
        {
            ...
            SqlDataAdapter adapter = new SqlDataAdapter(query, conecion);
        ...
        {
            SqlConnection conecion = new SqlConnection("server=LAPTOP-KQH2TR9E; database=Nomina; Integrated Security=True");
            SqlCommand cm = new SqlCommand("Select * From Empleados where Id=@Id", conecion);
        ...
        {
            conecion.Open();
            SqlDataAdapter adapter = new SqlDataAdapter("SP_InsertarNomina", conecion);
